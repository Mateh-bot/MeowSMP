...
import org.mateh.meowSMP.listeners.BlackCatHitListener;
import org.mateh.meowSMP.listeners.FallDamageListener;
import org.mateh.meowSMP.listeners.TokenListener;
import org.mateh.meowSMP.listeners.TokenSpawnListener;
...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new TokenSpawnListener(this), this);
