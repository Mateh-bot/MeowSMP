...
public abstract class AbstractToken {
    ...
    public void showCooldownBossBar(Player player) {
        BossBar bossBar = Bukkit.createBossBar(getDisplayName() + " Cooldown: " + cooldownSeconds + " seconds", BarColor.RED, BarStyle.SOLID);
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                double progress = (double) timeLeft / cooldownSeconds;
